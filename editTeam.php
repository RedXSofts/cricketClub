...
<div id="wrapper">
    ...
    if (isset($_POST['addTeam']))
    {
        ...
        $check = $tm->updateTeam($team_name,$location, $id);
    }
                        ...
                        <form role="form" class="col-lg-7" method="post" action="">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" value="<?php echo $team['teamName']; ?>"  required type="text" name="team_name"  placeholder="Enter Name" />
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" value="<?php echo $team['location']; ?>" required type="text"  name="location" placeholder="Enter Location" />
                                </div>
                            </div>
